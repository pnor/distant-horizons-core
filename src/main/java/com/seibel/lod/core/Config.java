...
// This is the new config that will be added after 1.6 gets released
// Just preparing it so i can add the new config quicker later on
/** DONT USE THIS YET, THIS IS FOR AFTER 1.6 */
@Deprecated // I just put this so it will cross it whenever you try to use this
public class Config
{
    // CONFIG STRUCTURE
    // 	-> Client
    ...
    public static class Client
    {
        ...
        public static class Graphics
        {
            ...
            public static class AdvancedGraphics
            {
                ...
                @ConfigAnnotations.Entry
                public static ConfigEntry alwaysDrawAtMaxQuality = new ConfigEntry.Builder<Boolean>()
                        .comment(ILodConfigWrapperSingleton.IClient.IGraphics.IAdvancedGraphics.ALWAYS_DRAW_AT_MAD_QUALITY_DESC)
                        .set(ILodConfigWrapperSingleton.IClient.IGraphics.IAdvancedGraphics.ALWAYS_DRAW_AT_MAD_QUALITY_DEFAULT)
                        .build();
